VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} Verificador3 
   Caption         =   "| CIDA | REGISTRO LANCHE TARDE"
   ClientHeight    =   8910.001
   ClientLeft      =   105
   ClientTop       =   450
   ClientWidth     =   12300
   OleObjectBlob   =   "Verificador3.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "Verificador3"
    ...
    Do While Rng.Value <> ""
        Rng.Select
            ...
            If Str(Rng.Value) = Str(valor) Then
                ...
                If Rng.Offset(0, 7).Value = "Sim" Then
                    ...
                    HoraRegistrada.Caption = Format(Rng.Offset(0, 8).Value, "HH:MM:SS")
                    
                    
                    'Atualiza a Foto
                    Foto.Visible = True
                    Foto2.Visible = False
                    Verificador3.Foto.Picture = LoadPicture(Pasta & NomeAluno.Caption & underline & TMatricula & underline & Turma.Caption & ext)
                ...
                Else
                    ...
                    Rng.Offset(0, 7).Value = "Sim"
                    Rng.Offset(0, 8).Value = Time
                    Rng.Offset(0, 9).Value = Date
