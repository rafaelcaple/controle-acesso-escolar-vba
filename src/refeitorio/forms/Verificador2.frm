VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} Verificador2 
   Caption         =   "| CIDA | REGISTRO ALMOÇO"
   ClientHeight    =   8910.001
   ClientLeft      =   105
   ClientTop       =   450
   ClientWidth     =   12300
   OleObjectBlob   =   "Verificador2.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "Verificador2"
        ...
        Rng.Select
            ...
            If Str(Rng.Value) = Str(valor) Then
                ...
                If Rng.Offset(0, 5).Value = "Sim" Then
                    ...
                    Foto.Visible = True
                    Foto2.Visible = False
                    Verificador2.Foto.Picture = LoadPicture(Pasta & NomeAluno.Caption & underline & TMatricula & underline & Turma.Caption & ext)
