VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} Verificador 
   Caption         =   "| CIDA | REGISTRO LANCHE MANHÃ"
   ClientHeight    =   8910.001
   ClientLeft      =   105
   ClientTop       =   450
   ClientWidth     =   12300
   OleObjectBlob   =   "Verificador.frx":0000
    ...
    Do While Rng.Value <> ""
        Rng.Select
            ...
            If Str(Rng.Value) = Str(valor) Then
                ...
                If Rng.Offset(0, 3).Value = "Sim" Then
                    ...
                    HoraRegistrada.Caption = Format(Rng.Offset(0, 4).Value, "HH:MM:SS")
                    
                    
                    'Atualiza a Foto
                    Foto.Visible = True
                    Foto2.Visible = False
                    Verificador.Foto.Picture = LoadPicture(Pasta & NomeAluno.Caption & underline & TMatricula & underline & Turma.Caption & ext)
                ...
                Else
                    ...
                    Rng.Offset(0, 3).Value = "Sim"
                    Rng.Offset(0, 4).Value = Time
